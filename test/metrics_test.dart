...
void main() {
  test('Pdf Font Metrics', () {
    ...
    final File ttfFont = File('fonts/OpenSans-Regular.ttf');
    final Uint8List fontData = ttfFont.readAsBytesSync();
    final PdfTtfFont font = PdfTtfFont(pdf.document, fontData.buffer.asByteData());

    for (int letter
        in 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz&%!?0123456789'.codeUnits) {
      pdf.addPage(Page(
