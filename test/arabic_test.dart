...
void main() {
  ...
  test('Arabic Diacritics', () {
    final ArabicText a = ArabicText('السلام', <int>[65249, 65276, 65204, 65247, 65165]);
    final ArabicText b = ArabicText('السَلَاْمٌ', <int>[1612, 65249, 1618, 1614, 65276, 1614, 65204, 65247, 65165]);
