...
void main() {
  ...
  setUpAll(() {
    ...
    final Uint8List defaultFont = File('fonts/OpenSans-Regular.ttf').readAsBytesSync();
    final Uint8List defaultFontBold =File('fonts/OpenSans-Bold.ttf').readAsBytesSync();
  ...
  test('f',() {
    final File file = File('widgetsd.pdf');
    print('${file.path}');
